    ...
    public static void main(String[] args){
        try{
            for(EcsbClassifiers classifier : EcsbClassifiers.values()){
                System.out.println(classifier.getClassName() + " - starting time:" + new Timestamp(System.currentTimeMillis()));
                ...
                System.out.println(classifier.getClassName() + " - end time:" + new Timestamp(System.currentTimeMillis()));
            }
        } catch (IOException e) {
